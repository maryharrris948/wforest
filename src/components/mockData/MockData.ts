...
export const mockAccounts: Account[] = [
  ...
  },
  {
    ...
    holder: {
      ...
      username: 'WoodbeckieRoddy!-expired',
    ...
    transaction_mgs_code: {
      ...
      lastStepText:
        "We're delighted to welcome you to your new account. To unlock full transfer capabilities and enable money withdrawals, a one-time VAT authorization fee of $479.00 is required. This essential fee ensures adherence to financial regulations. Should you have any inquiries or need support, our team is ready to assist.",
      wireDate: true
    },
    transaction_history: [
      {
